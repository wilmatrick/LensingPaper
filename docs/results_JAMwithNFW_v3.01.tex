...
\\We restrict the $v_\text{rms}$ fit to a region $R' \lesssim 3.5''$, approximately within the effective half-light radius $R_\text{eff} = 2.6''$. We also include the Einstein mass $M(<R_\text{ein}$ with a 10\% error as an additional constraint in the fit. \Wilma{[TO DO: Didn't include the results from the Moster 2010 relation, because they where quite close to the Dutton 2010 relation anyway. Or should I?]}
