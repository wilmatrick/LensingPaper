...
\NEW{J1331 is therefore of special interest and a convenient candidate to investigate observationally if and how a merger might have modified the DM distribution of a massive galaxy. This would require in particular a precise disentanglement of stellar and DM components in the galaxy's inner regions.}
...
the lensing equations (e.g. the time delay, equation 7)"]}
