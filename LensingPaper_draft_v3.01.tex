...
%--------------------------------------------
%Introduction
\input{docs/introduction_v3.02} %[Fast fertig ueberarbeitet - fehlen noch 2 referenzen.]
%--------------------------------------------

%------------------------
\section{Modelling} \label{sec:Modelling}
\input{docs/model_MGE_v3.01}
\input{docs/model_lensing_v3.01}
\input{docs/model_JAM_v3.01}
%------------------------

%------------------------
\input{docs/data_v3.02}
%------------------------

%------------------------
\section{Results} \label{sec:Results}
\input{docs/results_photometry_v3.01}
\input{docs/results_lensing_v3.01}
\input{docs/results_JAMwithSB_v3.01}
