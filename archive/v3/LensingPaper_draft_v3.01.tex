...
%--------------------------------------------
%Introduction
\input{docs/introduction_v3.02} %[Fertig gekuerzt. Captions fertig. Eine Referenz ist noch unklar.]
%--------------------------------------------
...
\input{docs/results_photometry_v3.02} %[Fertig.]
\input{docs/results_lensing_v3.01} %[Fertig.]
\input{docs/results_JAMwithSB_v3.01} %[Fertig.]
