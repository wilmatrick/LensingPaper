...
%--------------------------------------------
%Introduction
\input{docs/introduction_v1.01}
%--------------------------------------------

%------------------------
\section{Modelling}
\input{docs/model_MGE_v1.01}
\input{docs/model_lensing_v1.02}
\input{docs/model_JAM_v1.01}
%------------------------

%------------------------
\input{docs/data_v1.01}
%------------------------

%------------------------
\section{Results}
\input{docs/results_photometry_v1.01}
\input{docs/results_lensing_v1.02}
\input{docs/results_JAMwithSB_v1.01}
\input{docs/results_JAMwithNFW_v1.01}
%------------------------

%------------------------
\section{Discussion and Conclusion}
\input{docs/discussion_ML_v1.02}
\input{docs/discussion_merger_v1.01}
\input{docs/summary_v1.01}
%------------------------
